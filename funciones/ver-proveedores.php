...
<head>
    ...
    <title>David's Toys - Providers</title>
</head>
...
<body>
    ...
    <content>
        <section class="container">
                ...
                <tbody>
                    ...
                    if ($result->rowCount() > 0) {
                        foreach (($result->fetchAll(PDO::FETCH_OBJ)) as $row) {
                            ...
                            echo "<td>" . $row->id . "</td>";
                            echo "<td>" . $row->name . "</td>";
                            echo "<td>" . $row->firstDelivery . "</td>";
                            echo '<td>' .  '<a role="button" href = "./editar-proveedor.php?id=' . $row->id . '" class="btn btn-info">Edit</a>' .
                                '          ' . '<a role="button" href = "./borrar-proveedor.php?id=' . $row->id . '" class="btn btn-danger">Delete</button>' . '</td>';
                            echo "</tr>";
                        }
                    }
                    ?>
            ...
            <div class="row">
                <div class="col">
                    <a role="button" href="./agregar-proveedor.php" class="btn btn-success">Add Provider</a>
                </div>
                <form method=POST action="crear-copia.php">
                    <div class="col">
                        <button name="createBackUp" value="providers" type="submit" class="btn btn-secondary">Create backup</button>
                    </div>
                </form>
                <form method=POST action="cargar-copia.php">
                    <div class="col">
                        <button name="showBackUp" value="providers" type="submit" class="btn btn-secondary">View backup</button>
                    </div>
                </form>
                <form method=POST action="graficar.php">
                    <div class="col">
                        <button name="showGraph" value="providers" type="submit" class="btn btn-info">Graph</button>
                    </div>
                </form>
            </div>
        </section>
