...
<head>
    ...
    <title>David's Toys - Products</title>
</head>
        ...
        <section class="container">
            ...
            <table id="datatable" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    $query = "SELECT products.id, products.name, products.price , products.stock, categories.name AS category 
                            FROM products LEFT JOIN categories ON products.idCategory = categories.id";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<td>' .  '<a role="button" href = "./editar-producto.php?id=' . $row["id"] . '" class="btn btn-info">Edit</a>' .
                            '          ' . '<a role="button" href = "./borrar-producto.php?id=' . $row["id"] . '" class="btn btn-danger">Delete</button>' . '</td>';
                        echo "</tr>";
                    }
                    ?>
                </tbody>
            ...
            <div class="row">
                <div class="col">
                    <a role="button" href="./agregar-producto.php" class="btn btn-success">Add Product</a>
                </div>
                <form method=POST action="crear-copia.php">
                    <div class="col">
                    <button name="createBackUp" value="products" type="submit" class="btn btn-secondary">Create backup</button>
                    </div>
                </form>
                <form method=POST action="cargar-copia.php">
                    <div class="col">
                        <button name="showBackUp" value="products" type="submit" class="btn btn-secondary">View backup</button>
                    </div>
                </form>
                <form method=POST action="graficar.php">
                    <div class="col">
                        <button name="showGraph" value="products" type="submit" class="btn btn-info">Graph</button>
                    </div>
                </form>
            </div>
        </section>
