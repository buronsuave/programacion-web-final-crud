...
<head>
    ...
    <title>David's Toys - Categories</title>
</head>
...
<body>
    ...
    <content>
        <section class="container">
            ...
            <table id="datatable" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>" . $i . "</td>";
                        echo "<td>" . $row["name"] . "</td>";
                        echo '<td>' .  '<a role="button" href = "./editar-categoria.php?id=' . $row["id"] . '" class="btn btn-info">Edit</a>' .
                            '          ' . '<a role="button" href = "./borrar-categoria.php?id=' . $row["id"] . '" class="btn btn-danger">Delete</button>' . '</td>';
                        echo "</tr>";
                    }
                    ?>
                </tbody>
            ...
            <div class="row">
                <div class="col">
                    <a role="button" href="./agregar-categoria.php" class="btn btn-success">Add Category</a>
                </div>
                <form method=POST action="crear-copia.php">
                    <div class="col">
                        <button name="createBackUp" value="categories" type="submit" class="btn btn-secondary">Create backup</button>
                    </div>
                </form>
                <form method=POST action="cargar-copia.php">
                    <div class="col">
                        <button name="showBackUp" value="categories" type="submit" class="btn btn-secondary">View Backup</button>
                    </div>
                </form>
                <form method=POST action="graficar.php">
                    <div class="col">
                        <button name="showGraph" value="categories" type="submit" class="btn btn-info" disabled>Graph</button>
                    </div>
                </form>
            </div>
        </section>
